...
| **Original** | [sequoiacap.com/article/pmf-framework](https://sequoiacap.com/article/pmf-framework) |
| **This copy** | Markdown export for reference while writing about product-market fit. All text and images belong to Sequoia. |
...
- [3 Archetypes of Product-Market Fit](#3-archetypes-of-product-market-fit)
- [How to Operate in Each Path](#how-to-operate-in-each-path)
  - [Path 1: Hair on Fire](#path-1-hair-on-fire)
  - [Path 2: Hard Fact](#path-2-hard-fact)
  - [Path 3: Future Vision](#path-3-future-vision)
...
![The Arc Product-Market Fit Framework. A grid of three archetypes against market and product columns. Hair on Fire: customer mindset "Help me now", crowded category, must overcome noise, best-in-class solution, failure mode out-competed, winning ingredient be different not merely better. Hard Fact: "It is what it is", stagnant category, must overcome habit, novel solution for an accepted pain, failure mode problem isn't worth solving, winning ingredient upend the status quo. Future Vision: "Yeah, right", non-existent category, must overcome disbelief, new paradigm, failure mode wrong path to the future, winning ingredient make sci-fi a reality.](https://framerusercontent.com/images/PgIc7Om87C4FNxpKmsqb31Tr2G0.webp?width=1600)

### Hair on Fire

![Line drawing of a rollercoaster cresting a peak with sparks flying, the Hair on Fire icon](https://framerusercontent.com/images/Xhy36Po9mhyCYPjtJ0PZrC8dKc.webp?width=600)
...
![Line drawing of a large boulder or rock face in a field of grass, the Hard Fact icon](https://framerusercontent.com/images/7FJsQe2BVIsqIGW71iPPQsLgQg.webp?width=600)
...
![Line drawing of a rocket lifting off from a curved horizon beside a star, the Future Vision icon](https://framerusercontent.com/images/jQbhBBEg4URb3HxIbh252s8XPmo.webp?width=600)
...
> **Operating takeaway:** On this path, you're entering a competitive fight. Aggression is your friend.

| | Market | Product |
|---|---|---|
| **Customer mindset** | Your customer is likely already using or evaluating products from competitors to solve their problem. They're in comparison-shopping mode, with high awareness of feature sets and pricing. | **Value prop.** A product so standout that customers would break a contract to switch to your solution sooner. |
| **Category** | The category is probably crowded with competitors. You're likely to have relatively low pricing power. You need a large market for the payoff to be worth it. | **Failure mode.** You risk being out-competed. Velocity is paramount on this path. You need to move quickly to press your advantage on differentiation and consolidate market share. |
| **Must overcome** | You must overcome the noise if you're going to stand out and win. Customers get barraged with sales and marketing messages. | **Winning ingredients.** Success depends on a differentiated customer experience. Technical differentiation that's hard to copy can be a key advantage in a crowded market. |

*Table transcribed from the article's Hair on Fire operating slide, shown below.*

![Hair on Fire operating slide, the source for the table above](https://framerusercontent.com/images/VgeiYsnCV5BRjsuv674LKq9BSk.webp?width=1600)

#### Case studies: Hair on Fire
...
> **Operating takeaway:** There are two sides to the equation: a problem that *matters enough* to motivate change, and a solution that's *compelling enough* to be persuasive.

| | Market | Product |
|---|---|---|
| **Customer mindset** | Your customers carry assumptions about "how the world works" that run contrary to your solution. There's latent demand, but it must be unlocked by a novel approach. | **Value prop.** Your solution represents a novel approach to solving something customers had assumed would always stay broken. |
| **Category** | You likely face a less crowded market. It may be a stagnant category that's overdue for innovation, or you may forge a new category where there was previously just a patchwork of hacks and legacy workarounds. | **Failure mode.** You address an important problem with an unconvincing solution, or you create a convincing solution to a problem that's just not that important. |
| **Must overcome** | You'll need to overcome habits and attitudes about the accepted status quo. Routines are entrenched, because it takes effort to adapt to a new way. | **Winning ingredients.** You'll likely require an epiphany in your customer's mind to "unlock" your value prop. Messaging will play an integral role; but your product must deliver on the promise. |

*Table transcribed from the article's Hard Fact operating slide, shown below.*

![Hard Fact operating slide, the source for the table above](https://framerusercontent.com/images/XnbjAQENT1t7GSchzrm5Us1OfA.webp?width=1600)

#### Case studies: Hard Fact
...
> **Operating takeaway:** Finding a viable path will likely involve non-obvious pit stops, potentially even serving a different customer or market segment than you initially envisioned.

| | Market | Product |
|---|---|---|
| **Customer mindset** | Your customer either has no context for the problem (no one knew they needed an iPhone before they saw it) or they have context but assume it's beyond the realm of reality. Either way, they're not looking to solve it. | **Value prop.** Beyond offering new ways to fix existing problems, you usher in a new paradigm altogether, often enabling an ecosystem of possibilities. |
| **Category** | You face scant to no competition. Winning market share is less important than gaining initial adoption. If you maintain market share as demand grows, you will have maximum pricing power and this can become a huge advantage. | **Failure mode.** Even if your ultimate vision is correct, failing to find a viable path from here to there can be your undoing: you'll exhaust your capital before achieving your mission. |
| **Must overcome** | You must convince customers both that your product is real and viable, and that it will shape how the world works instead of becoming a failed fad. | **Winning ingredients.** Making sci-fi a reality requires the perseverance to pursue your vision as long as it takes, and the resilience to course correct as you go. |

*Table transcribed from the article's Future Vision operating slide, shown below.*

![Future Vision operating slide, the source for the table above](https://framerusercontent.com/images/wihplnvAfWq0Ov8mU7ytgm0AKgw.webp?width=1600)

#### Case studies: Future Vision
...
![The Arc Product-Market Fit Diagnostic. Six diagnostic questions per archetype, split across market and product. Hair on Fire market: are your customers actively in market comparing their options, is your customer being marketed to by a range of solution providers, is the market worth the fight. Hair on Fire product: do customers immediately understand your difference, is your customer compelled by your difference, are you moving faster than the competition. Hard Fact market: do customers make do with existing solutions and workarounds, are there well-established incumbents or legacy solutions, do customers care enough to change existing habits. Hard Fact product: does your product lead to a customer awakening, does your product break one habit and create a new one, does your product define or redefine a category. Future Vision market: do your customers not realize they are customers, has something shifted that makes the impossible possible, is the future you see the right one. Future Vision product: do you have the capital and conviction to build the future you see, do you have the technical and commercial roadmap to get you there, does your product make the future now.](https://framerusercontent.com/images/OBcGNpSLoOEh5DB01QMbeQFkPxw.webp?width=1600)
...
![Apple Product-Market Fit Journey. A timeline from 1984 to 2024 plotted against the three archetypes. 1984 Macintosh sits in Future Vision, 1998 iMac moves up to Hard Fact, 2007 iPhone drops back to Future Vision, 2010 smartphone crowds rise to Hair on Fire, and 2024 Apple Vision Pro returns to Future Vision.](https://framerusercontent.com/images/AVzpydCLnykDATJZb3nGPbDOO4c.webp?width=1600)
...
For further reading on how to put it into action, see the Arc Terrifying Questions Framework.

---

## Appendix: The Arc PMF Framework at a glance

*Transcribed from the framework slide near the top of the article.*

| | Hair on Fire | Hard Fact | Future Vision |
|---|---|---|---|
| **Customer mindset** | "Help me *now*" | "It is what it is." | "Yeah, right." |
| **Category** | Crowded | Stagnant | Non-existent |
| **Must overcome** | Noise | Habit | Disbelief |
| **Value prop** | Best-in-class solution | Novel solution for an accepted pain | New paradigm |
| **Failure mode** | Out-competed | Problem isn't worth solving | Wrong path to the future |
| **Winning ingredient** | Be different, not merely better | Upend the status quo | Make sci-fi a reality |

## Appendix: The Arc PMF Diagnostic

*Transcribed from the diagnostic slide. Six questions per archetype: three about your market, three about your product.*

**Hair on Fire**

| Market | Product |
|---|---|
| Are your customers actively in market comparing their options? | Do customers immediately understand your difference? |
| Is your customer being marketed to by a range of solution providers? | Is your customer compelled by your difference? |
| Is the market worth the fight? | Are you moving faster than the competition? |

**Hard Fact**

| Market | Product |
|---|---|
| Do customers make do with existing solutions and workarounds? | Does your product lead to a customer awakening? |
| Are there well-established incumbents or legacy solutions? | Does your product break one habit and create a new one? |
| Do customers care enough to change existing habits? | Does your product define or redefine a category? |
...
Vicki Peng and Zefi Hennessy Holland presented this framework at Slush, where they also walked through a second framework on the four areas of conviction. That talk is not part of the article, but it covers the same material with extra examples such as Linear.

| Talk | Speakers | Video | Transcript |
|---|---|---|---|
| Deconstructing Product-Market Fit (Slush) | Vicki Peng, Zefi Hennessy Holland | [YouTube](https://www.youtube.com/watch?v=18A84qjVbeo) | [transcript](sequoia-arc-pmf-framework/transcripts/01-slush-deconstructing-pmf.md) |
